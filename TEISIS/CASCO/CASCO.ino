...
void setup() {
  ...
  radio.begin();
  radio.openWritingPipe(0xF0F0F0E1LL); // Dirección de destino
  radio.setPALevel(RF24_PA_LOW); // Establecer la potencia de transmisión (ajústala según sea necesario)
