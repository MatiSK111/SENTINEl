...
void obtenerlocacion(String rut){
  ...
  double latdef = 0.000000;//latitud por defecto
  double londef = 0.000000;//longitud por defecto
...
void beep() {
  for (int i = 0; i < 10; ++i) {
    ...
    delay(250);                                          // Espera 120 milisegundos antes de cambiar el tono
 }
}
